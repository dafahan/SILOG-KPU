				...
				<a href="#" class="btn btn-primary my-2" onclick="show('add-modal')" >
					...
					<form action="<?=base_url('barang/store')?>" method="post">
						...
						<div class="mb-3 row ">
							...
							<input type="date" name="keluar" class="form-control" id="exampleInputPassword1" required>
						</div>
						<div class="mb-3 row">
                        ...
                        <table class="table table-stripped" style='word-wrap: break-word; table-layout: fixed;'>
							<thead>
								<tr>
									...
									<th scope="col" style="width:15%">Tanggal Keluar</th>
							...
							<tbody>
								...
								<?php $no=1; foreach($barang_masuk as $barang):?>
									...
									<td><?= ($barang['keluar']=="0000-00-00")?"Belum di atur" : $barang['keluar'] ?></td>
									<td><?= $barang['status']?></td>
									...
									<form action="<?=base_url('barang/store')?>" method="post">
										...
										<div class="mb-3 row ">
											...
											<input type="date" value="<?= $barang['keluar']?>" name="keluar" class="form-control" id="exampleInputPassword1" required>
										</div>
										<div class="mb-3 row">
											<label for="exampleInputEmail1" class="form-label">Status Barang</label>
